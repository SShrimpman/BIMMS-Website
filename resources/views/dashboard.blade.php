    ...
    <div id="parallax" style="perspective: 10px;" class="relative h-screen overflow-y-auto overflow-x-hidden">
        ...
        <div style="transform-style: preserve-3d;" class=" relative flex justify-center h-full w-screen -z-10">
            ...
            <div class="flex flex-col z-10">
                <div id="bimms2" class="flex justify-center mt-36 desktop:mt-36 w-screen text-5xl desktop:text-[6rem] text-white drop-shadow-[0_0_5px_rgba(0,20,20,1)] font-extrabold opacity-0 transition-all ease-in delay-[1500ms] duration-1000">The Future of</div>
                <div id="bimms3" class="flex justify-center desktop:mt-20 w-screen text-4xl desktop:text-[5rem] text-[#6fc3c0] drop-shadow-[0_0_5px_rgba(0,136,175,1)] font-extrabold opacity-0 transition-all ease-in delay-[2500ms] duration-1000">Data Centers!</div>
                <div id="bimms4" class="flex justify-center w-screen desktop:text-lg mt-20 desktop:mt-24 text-white font-extrabold opacity-0 transition-all ease-in delay-[3500ms] duration-1000">
