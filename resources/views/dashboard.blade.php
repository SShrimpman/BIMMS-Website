    ...
    <div id="parallax" style="perspective: 10px;" class="relative h-screen overflow-y-auto overflow-x-hidden">
        ...
        <div style="transform-style: preserve-3d;" class=" relative flex justify-center h-full w-screen -z-10">
            ...
            <div class="flex flex-col z-10">
                <div id="bimms2" class="flex justify-center mt-36 desktop:mt-36 w-screen text-5xl desktop:text-[7rem] text-white drop-shadow-[0_0_5px_rgba(0,20,20,1)] font-extrabold opacity-0 transition-all ease-in delay-[1500ms] duration-1000">The Future of</div>
